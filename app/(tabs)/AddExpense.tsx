...
const styles = StyleSheet.create({
  ...
  typeButton: { flex: 1, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: '#ccc', borderRadius: 20, marginHorizontal: 10 },
  typeButtonSelected: { backgroundColor: '#F88585', borderColor: '#F88585' },
  typeText: { fontSize: 16, color: '#333', fontFamily: 'Poppins' },
  ...
  saveButtonText: { color: '#fff', fontSize: 16, fontWeight: 'bold', fontFamily: 'Poppins' },
